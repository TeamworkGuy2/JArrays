...
public final class ArrayManaged {
	public int size;
	public Object[] data;
	 ...
	 */
	public static  boolean remove(boolean[] data, int size, boolean item) {
	 ...
	 */
	public static final boolean[] expandArray(boolean[] oldAry) {
	 ...
	 */
	public static final boolean[] expandArray(boolean[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(byte[] data, int size, byte item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final byte[] expandArray(byte[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final byte[] expandArray(byte[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(short[] data, int size, short item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final short[] expandArray(short[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final short[] expandArray(short[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(char[] data, int size, char item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final char[] expandArray(char[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final char[] expandArray(char[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(int[] data, int size, int item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final int[] expandArray(int[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final int[] expandArray(int[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(long[] data, int size, long item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final long[] expandArray(long[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final long[] expandArray(long[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(float[] data, int size, float item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final float[] expandArray(float[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final float[] expandArray(float[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static  boolean remove(double[] data, int size, double item) {
		// Search for the item to remove
		for(int i = 0; i < size; i++) {
			// If the item is found, remove it
			if(item == data[i]) {
	 ...
	 * Note: expands array ~1.5x it's current size
	 */
	public static final double[] expandArray(double[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 * Note: expands array ~1.5x it's current size, up to a maximum of {@code maxSize}
	 */
	public static final double[] expandArray(double[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
	 ...
	 * @return true if the element was removed successfully, false otherwise
	 */
	public static <T> boolean remove(T[] data, int size, T item) {
		// Search for the item to remove
		if(item != null) {
			for(int i = 0; i < size; i++) {
				// If the item is found, remove it
	...
	public static final <T> T[] expandArray(T[] oldAry) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final <T> T[] expandArray(T[] oldAry, int maxSize) {
		// Expand array size 1.5x + 4, +4 instead of +1 to prevent small arrays from constantly needed to resize
		int newSize = Math.max(maxSize, oldAry.length + (oldAry.length >>> 1) + 4);
