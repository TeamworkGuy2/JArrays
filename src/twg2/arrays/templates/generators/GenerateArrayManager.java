 ...
 * @since 2014-12-28
 */
public class GenerateArrayManager {
	...
	public static final void generateArrayManager() throws IOException {
		ArrayInfo info = new ArrayInfo();
		info.className = "ArrayManager";
		info.packageName = "twg2.arrays";

		info.types = aryTypes;

		ST stTmpl = STTemplates.fromFile(tmplDir + "TArrayManager.stg", "TArrayManager", importsMapper);
